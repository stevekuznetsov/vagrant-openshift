  ...
  module Openshift
    ...
    class AWS
      ...
      def self.find_ami_from_tag(ui, compute, ami_tag_prefix, required_name_tag=nil)
        required_name_info = required_name_tag.nil? ? "" : "and required tag Name=#{required_name_tag}"
        ui.info("Searching for latest base AMI with prefix #{ami_tag_prefix} #{required_name_info}")
